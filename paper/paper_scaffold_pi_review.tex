...
\begin{figure}[t]
  \centering
  \includegraphics[width=\linewidth]{experiments/pcam/pareto_analysis.png}
  \caption{PCam Pareto analysis (10\% training data, seed 42). (a)~Test AUC
    vs.\ parameter count across all five pooling variants. (b)~Head-to-head
    comparison at ${\sim}100$K parameters. (c)~Data efficiency: 1\% vs.\
    10\% training data at growth rate 12. (d)~Ranking at the ${\sim}100$K
    parameter budget.}
