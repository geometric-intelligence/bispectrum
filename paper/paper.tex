...
groups.
\end{abstract}
\noindent Code is available at \url{https://github.com/geometric-intelligence/bispectrum}.
...
Cohen's spherical CNN~\cite{cohen2018spherical} reaches 96\%/95\%/94\%
with learned equivariant convolutions. Our single-pass bispectrum
(94.8\%/94.8\%/94.9\%) is 1--2pp lower but has a tighter invariance gap
(0.0pp vs.\ 2.0pp).
