...
delivers numerically exact rotation invariance
...
\begin{table}[h]
  ...
  \begin{tabular}{llrrrrrr}
    ...
    \texttt{SO3onS2} & $\mathrm{SO}(3)$ & $\infty$ & 430 & -- & 26.54 & -- & -- \\
...
provides a stronger inductive bias that partially compensates for limited
training data.
However, at higher capacity (6M parameters, Appendix~\ref{app:organ3d-details}),
max pool overtakes the bispectrum ($78.5\%$ vs.\ $68.5\%$), suggesting the
completeness advantage is specific to the data-limited regime.
